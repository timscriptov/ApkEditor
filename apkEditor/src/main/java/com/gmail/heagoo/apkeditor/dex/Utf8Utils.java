...
public final class Utf8Utils {
     ...
     * @param length the length of the utf8 string to convert, not including any
     ...
     * @return non-null; the converted string
     */
    public static String utf8BytesWithUtf16LengthToString(byte[] bytes,
                                                          int start, int utf16Length) {
     ...
     * @param start       the start index of the utf8 string to convert
     * @param utf16Length the number of utf16 characters in the string to decode
     * @param readLength  If non-null, the first element will contain the number of
     *                    bytes read after the method exits
     * @return non-null; the converted string
     */
    public static String utf8BytesWithUtf16LengthToString(byte[] bytes,
                                                          int start, int utf16Length, int[] readLength) {
        char[] chars = localBuffer.get();
