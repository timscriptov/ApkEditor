 ...
 */
public class ResConfigFlags implements Serializable {
    ...
    private static final long serialVersionUID = 5902455009573386734L;
    ...
    public ResConfigFlags(char lang_c1, char lang_c2) {
        this(lang_c1, lang_c2, '\00', '\00');
    }

    public ResConfigFlags(char lang_c1, char lang_c2, char country_c1, char country_c2) {
        mcc = 0;
        mnc = 0;
        language = new char[]{lang_c1, lang_c2};
        region = new char[]{country_c1, country_c2};
        orientation = ORIENTATION_ANY;
        touchscreen = TOUCHSCREEN_ANY;
        density = DENSITY_DEFAULT;
        keyboard = KEYBOARD_ANY;
