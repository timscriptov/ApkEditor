...
public class ResStyleValue extends ResBagValue implements
    ...
    public void serializeToResValuesXml(XmlSerializer serializer,
        ...
        for (int i = 0; i < mItems.length; i++) {
            ...
            // This is pujiang's old implementation
//            ResValue resourceVal = spec.getDefaultResource().getValue();
//            // modified by Pujiang
//            if (resourceVal instanceof ResReferenceValue) {
//                continue;
//            } else if (resourceVal instanceof ResStringValue
//                    || resourceVal instanceof ResStyleValue
//                    || resourceVal instanceof ResBoolValue) {
